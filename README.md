...
With a Master's in Data Analytics and a BS in Cybersecurity, I specialize in translating high-level technical specifications—such as API endpoints, security protocols, and data pipelines—into clear, actionable resources for developers and stakeholders. My experience in high-compliance environments (Pharma/FDA) has trained me to produce documentation that is not only easy to read but accurate, secure, and audit-ready.
...
* Documented a POST endpoint for a machine learning data pipeline.  
...
* A procedural guide for setting up a local development environment.  
...
* A conceptual overview of Extract, Transform, Load (ETL) architecture.  
* Written for a mixed audience (Junior Devs & Product Managers).  
* Demonstrates the ability to simplify abstract cloud concepts into digestible content.

## **🛠 Technical Stack**

| Category | Tools & Technologies |
| :---- | :---- |
| **Documentation** | Markdown, Git (Docs-as-Code), Confluence, Jira, Swagger/OpenAPI |
| **Languages** | Python (Pandas/NumPy), SQL, JSON, XML, HTML/CSS |
| **Security** | NIST Frameworks, Access Control (IAM), Data Integrity Standards |
| **Workflow** | SDLC, Agile/Scrum, Version Control (GitHub) |
